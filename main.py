...
async def help(ctx, *, query=None):
    ...
    if not query:
        ...
        helpinfected = f"# **Sioz Selfbot v2**\n"
        ...
        helpinfected = f"**## Sioz Selfbot {found_cog.qualified_name} Cmds**\n\n"
...
class Info(commands.Cog):
    ...
    async def stats(self, ctx):
        ...
        infectedinfo = "# **__Sioz Selfbot__**\n\n"
        infectedinfo += "**• Sioz Selfbot: x2\n"
...
class Hentai(commands.Cog):
    ...
    async def anal(self, ctx):
        try:
            r = requests.get("https://nekobot.xyz/api/image?type=hentai_anal")
            r.raise_for_status()
            data = r.json()
            await ctx.send(data['message'])
        except requests.RequestException:
    ...
    @commands.command(
        name="kanna",
        usage="",
        description="Random pics of kanna"
    )
    @infected()
    async def kanna(self, ctx):
        try:
            r = requests.get("https://nekobot.xyz/api/image?type=kanna")
            r.raise_for_status()
            data = r.json()
            await ctx.send(data['message'])
        except requests.RequestException:
    ...
    @commands.command(name="hboobs", usage="", description="99% SFW")
    @infected()
    async def hboobs(self, ctx):
        try:
            r = requests.get("https://nekobot.xyz/api/image?type=hboobs")
            r.raise_for_status()
            data = r.json()
            await ctx.send(data['message'])
        except requests.RequestException:
